  ...
  <div class="col-12 col-lg-10">
    <div class="card shadow-sm">
      <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center border-bottom">
        ...
        <a href="{{ route('admin.program-contents.index', ['section' => $programContent->section]) }}" class="btn btn-outline-secondary">
      ...
      <div class="card-body py-4">
        ...
        <form action="{{ route('admin.program-contents.update', $programContent) }}" method="POST">
          ...
          <div class="row g-3">
            <!-- Title -->
            <div class="col-12">
              <label for="title" class="form-label fw-semibold">Judul / Eyebrow Text <span class="text-muted small">(Bisa berisi tag HTML span accent)</span></label>
            ...
            <div class="col-12">
              <label for="body" class="form-label fw-semibold">Body Content / Teks Deskripsi</label>
            ...
            <!-- Icon / SVG Raw -->
            <div class="col-12">
              <label for="icon" class="form-label fw-semibold">Icon (HTML/SVG Raw atau Teks Angka)</label>
            ...
            <div class="col-md-6 d-flex align-items-end">
              <div class="form-check form-switch mb-2">
                ...
                <label class="form-check-label fw-semibold" for="is_active">Aktifkan Konten ini di Halaman Publik</label>
              </div>
            </div>
          </div>
