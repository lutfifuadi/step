...
@section('title', 'Edit Kontak Konselor')
  ...
  <div class="col-lg-8 col-md-10 col-12">
    <div class="card shadow-sm" style="border-radius: 5px;">
      <div class="card-header bg-white py-3 border-bottom d-flex align-items-center justify-content-between" style="border-top-left-radius: 5px; border-top-right-radius: 5px;">
        <div>
          <h4 class="mb-0 fw-bold text-teal-deep">Edit Kontak Konselor</h4>
          <p class="text-muted small mb-0">Ubah informasi kontak konselor/BK di bawah ini dengan data yang diperbarui.</p>
        </div>
      ...
      <div class="card-body py-4">
        ...
        <form action="{{ route('admin.konselor.update', $konselor) }}" method="POST">
          @csrf
          @method('PUT')
          ...
          <div class="row g-3">
            <div class="col-12 col-md-6">
              ...
              <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" placeholder="Contoh: Dra. Hj. Siti Aminah, M.Pd." value="{{ old('name', $konselor->name) }}" style="border-radius: 5px;" required>
              @error('name')
            ...
            <div class="col-12 col-md-6">
              ...
              <input type="text" name="role" id="role" class="form-control @error('role') is-invalid @enderror" placeholder="Contoh: Koordinator BK / Konselor Utama" value="{{ old('role', $konselor->role) }}" style="border-radius: 5px;" required>
              @error('role')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            </div>
            ...
            <div class="col-12 col-md-6">
              ...
              <input type="text" name="institusi" id="institusi" class="form-control @error('institusi') is-invalid @enderror" placeholder="Contoh: MAN 1 Kota Bandung" value="{{ old('institusi', $konselor->institusi) }}" style="border-radius: 5px;" required>
              @error('institusi')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            </div>
            ...
            <div class="col-12 col-md-6">
              ...
              <input type="text" name="phone" id="phone" class="form-control @error('phone') is-invalid @enderror" placeholder="Contoh: 081234567890" value="{{ old('phone', $konselor->phone) }}" style="border-radius: 5px;" required>
            ...
            <div class="col-12 col-md-6">
              ...
              <input type="email" name="email" id="email" class="form-control @error('email') is-invalid @enderror" placeholder="Contoh: konselor@sekolah.sch.id" value="{{ old('email', $konselor->email) }}" style="border-radius: 5px;">
              @error('email')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            </div>
            ...
            <div class="col-12 col-md-6">
              ...
              <input type="text" name="room" id="room" class="form-control @error('room') is-invalid @enderror" placeholder="Contoh: Ruang BK Gedung A Lantai 1" value="{{ old('room', $konselor->room) }}" style="border-radius: 5px;">
              @error('room')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            </div>
            ...
            <div class="col-12 col-md-6">
              ...
              <input type="text" name="availability" id="availability" class="form-control @error('availability') is-invalid @enderror" placeholder="Contoh: Senin - Jumat, 07:00 - 15:00" value="{{ old('availability', $konselor->availability) }}" style="border-radius: 5px;">
              @error('availability')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            </div>
            ...
            <div class="col-12 col-md-6">
              ...
              <input type="number" name="sort_order" id="sort_order" class="form-control @error('sort_order') is-invalid @enderror" placeholder="Contoh: 1" value="{{ old('sort_order', $konselor->sort_order) }}" min="0" style="border-radius: 5px;" required>
            ...
            <div class="col-12 border-top pt-3 mt-3">
              <div class="form-check form-switch">
                <input class="form-check-input" type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', $konselor->is_active) ? 'checked' : '' }}>
