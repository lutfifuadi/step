    ...
    <div class="navbar navbar-expand-lg landing-navbar px-3 px-md-8">
      ...
      <div class="collapse navbar-collapse landing-nav-menu" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a href="{{ route('pages-home') }}" class="nav-link fw-bold @if($currentRouteName === 'pages-home') active @endif">Beranda</a>
          </li>
          <li class="nav-item">
            <a href="{{ route('tentang') }}" class="nav-link fw-bold @if($currentRouteName === 'tentang') active @endif">Tentang</a>
          </li>
          <li class="nav-item">
            <a href="{{ route('edukasi') }}" class="nav-link fw-bold @if($currentRouteName === 'edukasi') active @endif">Edukasi</a>
          </li>
          <li class="nav-item">
            <a href="{{ route('pencegahan') }}" class="nav-link fw-bold @if($currentRouteName === 'pencegahan') active @endif">Pencegahan</a>
          </li>
          <li class="nav-item">
            <a href="{{ route('ekspresi.create') }}" class="nav-link fw-bold @if($currentRouteName === 'ekspresi.create') active @endif text-primary">Ruang Ekspresi</a>
          </li>
        </ul>
      </div>
...
data-icon="device-desktop-analytics"></i>System</span>
        ...
        <!-- navbar button: Start -->
        <li>
          <a href="{{ route('auth-login-basic') }}" class="btn btn-primary"><span
